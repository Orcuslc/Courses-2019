...
using HDF5
h5write("./results/PG2.h5", "variables/x", xpath);
h5write("./results/PG2.h5", "variables/y", ypath);
h5write("./results/PG2.h5", "variables/z", zpath);
h5write("./results/PG2.h5", "variables/w", wpath);
h5write("./results/PG2.h5", "results/objective", fpath);
h5write("./results/PG2.h5", "results/dx", dxpath);
h5write("./results/PG2.h5", "results/dy", dypath);
h5write("./results/PG2.h5", "results/dz", dzpath);
h5write("./results/PG2.h5", "results/dw", dwpath);
h5write("./results/PG2.h5", "results/accuracy", accpath);